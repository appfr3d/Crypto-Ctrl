...
- (void)viewDidLoad {
    ...
    // [[NSUserDefaults alloc] initWithSuiteName:@"group.alfredla.Crypto-Ctrl"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Price
    [cell.widgetCryptoPriceLabel setText:[NSString stringWithFormat:@"US$ %@", cryptoDataObject.price_usd]];
    ...
    if ([diffText containsString:@"-"]) {
        ...
        [cell.widgetCryptoDifferenceLabel setBackgroundColor:[UIColor greenColor]];
